		...
		<section>
			...
			<div class="table-responsive">
				<table class="table table-bordered table-striped table-condensed">
					<thead>
						<tr>
							<th class="col-lg-1">時限</th>
							<th class="col-lg-1">月</th>
							<th class="col-lg-1">火</th>
							<th class="col-lg-1">水</th>
							<th class="col-lg-1">木</th>
							<th class="col-lg-1">金</th>
							<th class="col-lg-1">土</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td>1・2<br />9:00-10:30</td>
							<td></td>
							<td></td>
							<td>システムソフトウェア</td>
							<td></td>
